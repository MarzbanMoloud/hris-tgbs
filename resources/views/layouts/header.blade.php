            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        {{--LegalInformation--}}
                        <li ><a href="#"><i class="fa fa-dollar"></i> <span>اطلاعات حقوقی</span> <span class="sr-only"></span></a></li>
                        ...
                        <li class="dropdown">
                            <a href="https://www.jquery-az.com/bootstrap-tips-tutorials/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-bell"></i> <span>تسعیلات</span>
                                <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown">
                                    <a href="https://www.jquery-az.com/bootstrap-tips-tutorials/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> ایجاد وام </a></li>
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> لیست وام ها </a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown">
                                    <a href="https://www.jquery-az.com/bootstrap-tips-tutorials/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-bell"></i> <span>تضامین</span>
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> ایجاد ضمانت </a></li>
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> لیست تضامین </a></li>
                                    </ul>
                                </li>

                                <li class="dropdown">
                                    <a href="https://www.jquery-az.com/bootstrap-tips-tutorials/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-bell"></i> <span>مساعده</span>
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> ایجاد مساعده </a></li>
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> لیست مساعده ها </a></li>
                                    </ul>
                                </li>

                                <li class="dropdown">
                                    <a href="https://www.jquery-az.com/bootstrap-tips-tutorials/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-bell"></i> <span>گواهی شغلی</span>
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> ایجاد گواهی شغلی </a></li>
                                        <li><a class="nav-link" href="#"><i class="fa fa-plus"></i> لیست گواهی های شغلی </a></li>
                                    </ul>
                                </li>
